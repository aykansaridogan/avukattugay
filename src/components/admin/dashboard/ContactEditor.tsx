  ...
  return (
    <div style={{ display: 'grid', gap: '2rem' }}>
      ...
      <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
        <h4 style={{ fontSize: '1rem', marginBottom: '1.5rem', color: 'var(--primary)' }}>Sosyal Medya Linkleri</h4>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem' }}>
          <div className="form-group">
      ...
      <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
        <h4 style={{ fontSize: '1rem', marginBottom: '1.5rem', color: 'var(--primary)' }}>Randevu Kategorileri</h4>
          ...
          {data.appointmentCategories?.map((cat: string, index: number) => (
            <div key={index} style={{ 
              ...
              <button 
                ...
                style={{ background: 'transparent', border: 'none', color: '#ff4d4d', cursor: 'pointer', display: 'flex' }}
              >
                <Trash2 size={14} />
              </button>
            </div>
        ...
        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '1rem' }}>
          İpucu: Enter tuşuyla da kategori ekleyebilirsiniz.
        </p>
      </div>
    </div>
  );
